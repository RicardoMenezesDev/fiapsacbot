...
public class DicionarioSinonimosServico {
    ...
    public String sinonimoPalavra(String palavraOrigem) {
        ...
        //region Trabalho
        if (palavraOrigem.equals("tarefa") || palavraOrigem.equals("atividade") || palavraOrigem.equals("exercÃ­cio")
        ...
        if (palavraOrigem.equals("concluida") || palavraOrigem.equals("concluÃ­da")) {
